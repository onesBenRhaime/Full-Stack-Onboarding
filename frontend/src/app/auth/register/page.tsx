	...
	return (
		<>
			<section className="flex flex-col lg:flex-row lg:justify-start justify-center lg:items-start items-center lg:space-x-0 space-x-2 lg:space-y-32 space-y-2 fixed inset-0 lg:static">
				...
				<div
					className="lg:w-1/3 w-full p-4 lg:p-0 flex items-center justify-center lg:static absolute inset-0 lg:mt-32 mb-10 lg:mb-10  "
				...
				>
					...
					<div className="bg-white border rounded-xl px-5 py-8 w-full lg:w-auto">
						<h1
							className="font-bold text-3xl text-black "
							style={{ fontSize: "45px", lineHeight: "1.2" }}
						>
							Create New Account
						</h1>
